   ...
   execute: async (message, args, client, prefix) => {
    ...
    const row = new MessageActionRow()
      ...
      .setThumbnail('https://cdn.discordapp.com/app-icons/978900995386011718/bd441dbc9821a0e9a66af3b875014bdc.png')
       .setColor('#303236')
      .addFields({ name: 'Maukah kamu mendengarkan musik bersamaku?', value: `[Undang aku ke servermu!](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=36768832&scope=applications.commands%20bot)` } )

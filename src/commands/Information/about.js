...
module.exports = {
    ...
    .setURL("https://stat.ajieblogs.eu.org")
            ...
            .setColor('#303236')
            .addFields({ name: 'Developer/Maintainer', value: '[AjieDev a.k.a AjieG](https://github.com/AjieDev)', inline: true})
            .addFields({ name:'Made Using', value: 'Node.js', inline: true})
            .addFields({ name:'Hosted with', value: '**VPS Server**', inline: true})
            .addFields({ name:'\u200b', value: `CatBot Music is A Simple Audio Player for Discord, and its Free to use.`}
            )
